...
def generatewallet():
    ...
    genwalletpopup.geometry('1000x700')
    genwalletpopup.geometry('-100-200')

    l = Label(genwalletpopup, text="Input")
    l.grid(row=0, column=0)

    b = Button(genwalletpopup, text="Okay", command=genwalletpopup.destroy)
...
try:
    ...
    statusvar = "offline"
statuslabel = Label(
    window, text="newcoin server status: " + statusvar, font=('Arial', 15))
