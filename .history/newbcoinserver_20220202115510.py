...
def api_balance_check():
    ...
    pubkey = request.args.get('answer', default=1, type=str)
    if answer == currentpow:
        x = 2


serverdata = open('serverdata.txt', 'r')
currentpow = serverdata.read()
serverdata.close()
...
def add_new_block():
    ...
    newblock = {
        "LastHash": "lasthash",
        "POWhash": "hashedword",
        "Reciever": "ff074231f8b2b27280b652320021255564de2bada9d4598e447a11502fcd83ac5b79b463673b7894ad3d94dfd880e823274289d987e0647ed91e6205b46936bb",
        "Sender": "Transaction",
        "Time": "timehere",
