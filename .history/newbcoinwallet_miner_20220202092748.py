...
statusfromapi = requests.request("GET", url)
if statusfromapi.status_code == 200:
    print("nice the api works")
    statusvar = statusfromapi.text()
else:
    print("could not connect to api")
    statusvar = "offline"

statuslabel = Label(
    window, text="newcoin server status: online " + str(statusfromapi), font=('Arial', 15))
